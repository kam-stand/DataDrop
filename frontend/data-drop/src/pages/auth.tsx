...
import workflow from "../assets/data-drop-workflow.png";
import integration from "../assets/seamles--integration.png";
                ...
                <div className="auth-info">
                    <div className="info-card">
                        ...
                        <div>
                            <img
                                src={workflow}
                                style={{ width: "200px", height: "200px", border: "5px solid gray", borderRadius:"12px" }}
                                alt="workflows"
                            />
                        </div>
                    </div>
